...
{
    public class AgeRangerRepository<TEntity> : IAgeRangerRepository<TEntity> where TEntity : EntityBase
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="AgeRangerRepository{TEntity}"/> class.
        /// </summary>
        /// <param name="dbContext">
        /// The db context.
        /// </param>
        public AgeRangerRepository(AgeRangerDbContext dbContext)
        {
            if (dbContext == null)
            {
